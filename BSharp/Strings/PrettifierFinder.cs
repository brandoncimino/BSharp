...
public static class PrettifierFinders {
    // public static readonly PrettifierFinder ExactPrettifier      = new((db, t) => db.FindExact(t));
    ...
    internal static ImmutableArray<OptionalPrettifierFinder> DefaultFinders => new OptionalPrettifierFinder[] {
        FindExactPrettifier,
    ...
    internal static Optional<IPrettifier> FindPrettifier(
        ...
        [InstantHandle] IEnumerable<OptionalPrettifierFinder> finders
    ) {
    ...
    internal static Optional<IPrettifier> FindExactPrettifier(IPrettifierDatabase prettifierDatabase, Type type, PrettificationSettings settings) {
        ...
        return Optional.Optional.OfNullable(prettifierDatabase.FindExact(type));
    }
