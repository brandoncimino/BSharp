...
public static class Coercive {
    ...
    internal sealed class Operator {
        ...
        public Func<int, int, object>?           Int      { get; internal init; }
        public Func<float, float, object>?       Float    { get; internal init; }
        public Func<double, double, object>?     Double   { get; internal init; }
        public Func<long, long, object>?         Long     { get; internal init; }
        public Func<decimal, decimal, object>?   Decimal  { get; internal init; }
        public Func<short, short, object>?       Short    { get; internal init; }
        public Func<string, string, object>?     String   { get; internal init; }
        public Func<DateTime, TimeSpan, object>? DateTime { get; internal init; }
        public Func<TimeSpan, object, object>?   TimeSpan { get; internal init; }
        public Func<byte, byte, object>?         Byte     { get; internal init; }
        public Func<uint, uint, object>?         UInt     { get; internal init; }
        public Func<sbyte, sbyte, object>?       SByte    { get; internal init; }
        public Func<ulong, ulong, object>?       ULong    { get; internal init; }
        public Func<ushort, ushort, object>?     UShort   { get; internal init; }
