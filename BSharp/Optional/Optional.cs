...
namespace FowlFever.BSharp.Optional {
    ...
    public static class Optional {
        ...
        /**
         * <inheritdoc cref="Flatten{T}(FowlFever.BSharp.Optional.Optional{FowlFever.BSharp.Optional.Optional{T?}})"/>
         */
        [Pure]
        ...
        /// </summary>
        /// <remarks>
        /// Behind the scenes, this flips <paramref name="a"/> and <paramref name="b"/> and sends them to <see cref="AreEqual{T}(FowlFever.BSharp.Optional.IOptional{T}?,T?)"/>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// For the <see cref="Optional{T}"/> equivalent, see <see cref="OrElseThrow{T}(FowlFever.BSharp.Optional.IOptional{T},System.Func{System.Exception}?)"/>
        /// </remarks>
        /// <param name="nullable">a <see cref="Nullable{T}"/></param>
        /// <param name="exceptionProvider"><inheritdoc cref="OrElseThrow{T}(FowlFever.BSharp.Optional.IOptional{T},System.Func{System.Exception}?)"/></param>
